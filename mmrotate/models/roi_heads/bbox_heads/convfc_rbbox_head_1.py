        ...
        if cls_score is not None:
            ...
            if cls_score.numel() > 0:
                ...
                if self.custom_activation:
                    ...
                    acc = (losses['acc1']+losses['acc2'])/2
                acc1_weight = torch.pow(acc,self.pow_acc)
                if isinstance(loss_cls1_, dict):
                    losses.update(loss_cls1_)
                    losses.update(loss_cls2_)
                else:
                    losses['loss_cls1'] = loss_cls1_*acc1_weight
                    losses['loss_cls2'] = loss_cls2_*(1-acc1_weight)
