...
class YamiProDataset(CustomDataset):
    ...
    for name, label in NAME_LABEL_MAP_YaMi.items():
        CLASSES.append(('O'+name))

    for name, label in NAME_LABEL_MAP_cao_plane.items():
        CLASSES.append(name)
    ...
    def __init__(self,
        ...
        super(YamiProDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        ...
        if not ann_files:  # test phase
            ...
            for ann_file in ann_files:
                ...
                with open(ann_file,encoding='gbk') as f:
                    s = f.readlines()
                    for si in s:
                        bbox_info = si.split()
